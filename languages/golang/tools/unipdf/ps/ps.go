...
// Package ps implements various functionalities needed for handling Postscript for PDF uses, in particular
// for PDF function type 4.
package ps ;import (_a "bufio";_dc "bytes";_f "errors";_ad "fmt";_b "golang/unipdf/common";_ec "golang/unipdf/core";_e "io";_eb "math";);func (_afg *PSProgram )String ()string {_dgg :="\u007b\u0020";for _ ,_db :=range *_afg {_dgg +=_db .String ();
