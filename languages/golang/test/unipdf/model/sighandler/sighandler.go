...
package sighandler ;import (_ed "bytes";_cb "crypto";_cd "crypto/rand";_ad "crypto/rsa";_bd "crypto/x509";_ae "crypto/x509/pkix";_b "encoding/asn1";_ac "errors";_e "fmt";_ca "golang/pkcs7";_ge "github.com/unidoc/timestamp";_edb "lgo/test/unipdf/core";
_gd "lgo/test/unipdf/model";_ga "lgo/test/unipdf/model/mdp";_bg "lgo/test/unipdf/model/sigutil";_g "hash";_cf "math/big";_c "time";);
