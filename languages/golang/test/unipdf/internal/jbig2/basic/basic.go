...
package basic ;import _e "lgo/test/unipdf/internal/jbig2/errors";func (_cb *Stack )Len ()int {return len (_cb .Data )};func (_ge NumSlice )GetIntSlice ()[]int {_fg :=make ([]int ,len (_ge ));for _aaa ,_ba :=range _ge {_fg [_aaa ]=int (_ba );
