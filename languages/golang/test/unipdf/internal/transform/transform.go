...
package transform ;import (_a "fmt";_f "lgo/test/unipdf/common";_g "math";);func (_ead Point )String ()string {return _a .Sprintf ("(\u0025\u002e\u0032\u0066\u002c\u0025\u002e\u0032\u0066\u0029",_ead .X ,_ead .Y );};const _ef =1e9;func (_cg *Matrix )Set (a ,b ,c ,d ,tx ,ty float64 ){_cg [0],_cg [1]=a ,b ;
