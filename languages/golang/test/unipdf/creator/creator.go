...
//
package creator ;import (_ae "bytes";_g "encoding/xml";_c "errors";_cf "fmt";_eg "github.com/gorilla/i18n/linebreak";_gc "github.com/unidoc/unichart/render";_fe "lgo/test/unipdf/common";_ed "lgo/test/unipdf/contentstream";_dd "lgo/test/unipdf/contentstream/draw";
_ca "lgo/test/unipdf/core";_abd "lgo/test/unipdf/internal/graphic2d/svg";_eb "lgo/test/unipdf/internal/integrations/unichart";_ef "lgo/test/unipdf/internal/license";_bb "lgo/test/unipdf/internal/transform";
_fa "lgo/test/unipdf/model";_fbd "golang.org/x/text/unicode/bidi";_db "image";_e "io";_f "math";_d "os";_gg "regexp";_ab "sort";_fb "strconv";_aa "strings";_a "text/template";_dg "unicode";);
