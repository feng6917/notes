...
func (this *MyPageProcesser) Process(p *page.Page) {
	...
	name := query.Find("#J-lemma-main-wrapper > div:nth-child(1) > div > div.secondContent_cnx2Y > div.contentTop_sJfrU > div.lemmaTitleWrap_NznGh.lightText_P4VhQ.normal > div.lemmaTitleBox_cu08a > h1").Text()
	name = strings.Trim(name, " \t\n")
	// logrus.Info("name: ", name)

	summary := query.Find("#lemmaDesc > div").Text()
