...
package annotator ;import (_e "bytes";_ac "errors";_a "lgo/unipdf/common";_bd "lgo/unipdf/contentstream";_cc "lgo/unipdf/contentstream/draw";_cb "lgo/unipdf/core";_be "lgo/unipdf/internal/textencoding";
_ae "lgo/unipdf/model";_g "image";_ec "math";_c "strings";_d "unicode";);func _egb (_cddb *_ae .PdfField )string {if _cddb ==nil {return "";};_fbe ,_bec :=_cddb .GetContext ().(*_ae .PdfFieldText );if !_bec {return _egb (_cddb .Parent );
