...
//
package creator ;import (_ae "bytes";_g "encoding/xml";_c "errors";_cf "fmt";_eg "github.com/gorilla/i18n/linebreak";_gc "github.com/unidoc/unichart/render";_fe "lgo/unipdf/common";_ed "lgo/unipdf/contentstream";_dd "lgo/unipdf/contentstream/draw";
_ca "lgo/unipdf/core";_abd "lgo/unipdf/internal/graphic2d/svg";_eb "lgo/unipdf/internal/integrations/unichart";_ef "lgo/unipdf/internal/license";_bb "lgo/unipdf/internal/transform";
_fa "lgo/unipdf/model";_fbd "golang.org/x/text/unicode/bidi";_db "image";_e "io";_f "math";_d "os";_gg "regexp";_ab "sort";_fb "strconv";_aa "strings";_a "text/template";_dg "unicode";);
