...
package sampling ;import (_af "golang/unipdf/internal/bitwise";_e "golang/unipdf/internal/imageutil";_f "io";);type SampleWriter interface{WriteSample (_aadc uint32 )error ;WriteSamples (_gga []uint32 )error ;};func (_gb *Reader )ReadSample ()(uint32 ,error ){if _gb ._ad ==_gb ._g .Height {return 0,_f .EOF ;
