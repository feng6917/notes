...
package jbig2 ;import (_b "golang/unipdf/internal/bitwise";_ge "golang/unipdf/internal/jbig2/decoder";_gg "golang/unipdf/internal/jbig2/document";_c "golang/unipdf/internal/jbig2/document/segments";
_ba "golang/unipdf/internal/jbig2/errors";_g "sort";);func (_gee Globals )ToDocumentGlobals ()*_gg .Globals {if _gee ==nil {return nil ;};_ea :=[]*_c .Header {};for _ ,_cee :=range _gee {_ea =append (_ea ,_cee );};_g .Slice (_ea ,func (_gc ,_bef int )bool {return _ea [_gc ].SegmentNumber < _ea [_bef ].SegmentNumber });
