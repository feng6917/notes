...
package annotator ;import (_e "bytes";_ac "errors";_a "golang/unipdf/common";_bd "golang/unipdf/contentstream";_cc "golang/unipdf/contentstream/draw";_cb "golang/unipdf/core";_be "golang/unipdf/internal/textencoding";
_ae "golang/unipdf/model";_g "image";_ec "math";_c "strings";_d "unicode";);func _egb (_cddb *_ae .PdfField )string {if _cddb ==nil {return "";};_fbe ,_bec :=_cddb .GetContext ().(*_ae .PdfFieldText );if !_bec {return _egb (_cddb .Parent );
